...
def loss_fn(recon_x, x):
    dssim_loss = 1 - losses.dssim(recon_x, x, data_range=1, reduction='mean')
    tv_loss = losses.total_variation(recon_x)

    return dssim_loss + 0.1 * tv_loss  # Weight the TV loss with a factor of 0.1
